...
ggplot(grafico) + geom_col(aes(x = group, y = n, fill = ge_pia))
...
write.csv2(natal2, "natal2_processado.csv")
```
...
Você vai criar uma data pipeline parecida com a que acabamos de fazer para outro estado da federação.
