...
* O lucro do primeiro triste de 2016 é um missing **implícito**, porque ele nem aparece no banco.
...
4. O que aconteceria se você "alargasse" essa tabela? Como você poderia adicionar uma nova coluna to identificar cada valor de maneira única?
